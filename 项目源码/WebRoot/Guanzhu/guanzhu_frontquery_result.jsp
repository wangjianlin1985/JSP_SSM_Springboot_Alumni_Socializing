...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>关注id</td><td>被关注人</td><td>关注人</td><td>关注时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=guanzhu.getUserObj2().getName() %></td>
 											...
 											<td>
 												...
 												<a href="#" onclick="guanzhuDelete('<%=guanzhu.getGuanzhuId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="guanzhuQueryForm" id="guanzhuQueryForm" action="<%=basePath %>Guanzhu/frontlist" class="mar_t15" method="post">
