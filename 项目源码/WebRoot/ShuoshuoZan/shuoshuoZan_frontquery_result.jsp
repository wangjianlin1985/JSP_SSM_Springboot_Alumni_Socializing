		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#shuoshuoZanListPanel" aria-controls="shuoshuoZanListPanel" role="tab" data-toggle="tab">说说点赞列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ShuoshuoZan/shuoshuoZan_frontAdd.jsp" style="display:none;">添加说说点赞</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>点赞id</td><td>被点赞说说</td><td>点赞用户</td><td>点赞时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<shuoshuoZanList.size();i++) {
					    	            		...
					    	            		ShuoshuoZan shuoshuoZan = shuoshuoZanList.get(i); //获取到说说点赞对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="shuoshuoZanQueryForm" id="shuoshuoZanQueryForm" action="<%=basePath %>ShuoshuoZan/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="shuoshuoObj_shuoshuoId">被点赞说说：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;说说点赞信息编辑</h4>
      </div>
