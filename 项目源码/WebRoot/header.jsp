...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">校友录网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>UserInfo/frontlist">校友风采</a></li>
                <li><a href="<%=basePath %>PostInfo/frontlist">文章浏览</a></li>
                <!-- 
                <li><a href="<%=basePath %>Reply/frontlist">文章回复</a></li> 
                <li><a href="<%=basePath %>ZanInfo/frontlist">文章点赞</a></li>
                <li><a href="<%=basePath %>Comment/frontlist">说说评论</a></li>
                <li><a href="<%=basePath %>ShuoshuoZan/frontlist">说说点赞</a></li>
                -->
                <li><a href="<%=basePath %>Shuoshuo/frontlist">说说中心</a></li> 
                
                <li><a href="<%=basePath %>Guanzhu/frontlist">用户关注</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>PostInfo/postInfo_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布文章</a></li>
                        <li><a href="<%=basePath %>PostInfo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的文章</a></li>
                        <li><a href="<%=basePath %>Shuoshuo/shuoshuo_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布说说</a></li>
                        <li><a href="<%=basePath %>Shuoshuo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的说说</a></li>
